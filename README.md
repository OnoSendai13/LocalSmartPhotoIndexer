...
- EXIF writing: Fixed HTML entity encoding in database paths (e.g., `&eacute;` → `é`)
  - Decode HTML entities before filesystem operations
  - Works with Windows paths containing Unicode characters
